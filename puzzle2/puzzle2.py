...
def BFS(initialState):
    # initialize the frontier and enqueu the empty sequence into the frontier
    frontier = deque()
    frontier.append([])
    # while the frontier is not empty dequeue the sequence of actions and get the new state
    while frontier:
        current_actions = frontier.popleft()

        new_state = TransitionFunction(copy.deepcopy(initialState), current_actions)
